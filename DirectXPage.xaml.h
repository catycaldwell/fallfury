...
namespace Coding4Fun
{
	namespace FallFury
	{
		...
		private:
			...
			void OnScoreWriteCompleted(IAsyncOperation<Platform::Object^> ^op, AsyncStatus s);
			...
			void LoadHighscores();
			void OnHighscoreLoadCompleted(IAsyncOperation<Platform::Object^> ^op, AsyncStatus s);
