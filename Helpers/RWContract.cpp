...
RWContract::RWContract(_In_ Windows::Storage::StorageFolder^ folder)
{
    m_location = folder;
...
Platform::Array<byte>^ RWContract::ReadData(_In_ Platform::String^ filename)
{
...
task<Platform::Array<byte>^> RWContract::ReadDataAsync(_In_ Platform::String^ filename)
{
...
uint32 RWContract::WriteData(_In_ Platform::String^ filename, _In_ const Platform::Array<byte>^ fileData)
{
    CREATEFILE2_EXTENDED_PARAMETERS extendedParams = {0};
    extendedParams.dwSize = sizeof(CREATEFILE2_EXTENDED_PARAMETERS);
    extendedParams.dwFileAttributes = FILE_ATTRIBUTE_NORMAL;
...
task<void> RWContract::WriteDataAsync(_In_ Platform::String^ filename, _In_ const Platform::Array<byte>^ fileData)
{
